...
デバッグやら、ログコードを書くつらみで停止中


ctypes で、ごちゃごちゃと描き直そうと思っている
...
cpu のwhile ループは、ui のupdate に任せる
...
数値の型の変化(`u8` や`u16` とか`i8`やら)に気をつける


### ui やら、画像のほう


numpy 使った処理とか、処理コスト全くみてない
